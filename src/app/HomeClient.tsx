...
import HeroHome3 from "@/assets/img-heros/hero-home3.webp";
...
const BrandMarquee = dynamic(() => import("@/components/shared/BrandMarquee"), {
  loading: () => (
...
export default function HomeClient() {
  ...
  const currentMeta = isEN
    ? translations.en.metadata
    : translations.es.metadata;
  ...
  useEffect(() => {
    ...
    (canonical as HTMLLinkElement).href = "https://www.institutomexcolusa.com/";
    ...
    // Open Graph
    updateOGTag("og:title", currentMeta.title);
    updateOGTag("og:description", currentMeta.description);
    updateOGTag("og:url", "https://www.institutomexcolusa.com/");
    updateOGTag("og:type", "website");
    updateOGTag("og:locale", isEN ? "en_US" : "es_ES");

    // Twitter Card
    updateMetaTag("twitter:title", currentMeta.title);
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: isEN
              ? "What courses does Instituto Mex-Col-USA offer?"
              : "¿Qué cursos ofrece Instituto Mex-Col-USA?",
            acceptedAnswer: {
              "@type": "Answer",
              text: isEN
                ? "We offer professional courses in aesthetic medicine, including non-surgical facelift, serotherapy, facial harmonization, and phlebotomy certification with international recognition."
                : "Ofrecemos cursos profesionales en medicina estética, incluyendo lifting sin cirugía, suero terapia, armonización facial y certificación en flebotomía con reconocimiento internacional.",
            },
          },
          {
            "@type": "Question",
            name: isEN
              ...
              : "¿Los cursos están disponibles en línea?",
            acceptedAnswer: {
              "@type": "Answer",
              text: isEN
                ? "Yes, we offer both in-person and online training programs with flexible schedules and international certification."
                : "Sí, ofrecemos programas de capacitación presenciales y en línea con horarios flexibles y certificación internacional.",
            },
          },
          {
            "@type": "Question",
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: isEN
                ? "Instituto Mex-Col-USA operates in the United States, Mexico, and Colombia with professional training centers in each location."
                : "Instituto Mex-Col-USA opera en Estados Unidos, México y Colombia con centros de capacitación profesional en cada ubicación.",
            },
          },
        ],
      });
  ...
  }, [language, isEN, currentMeta]);

  useAutoPauseVideos();

  // Lazy mount for below-the-fold video section
  ...
  useEffect(() => {
    if (videosVisible) {
      // Force load videos to show first frame on iOS
  ...
  return (
    <div className="flex flex-col">
      ...
      <section id="testimonials" className="py-20 md:py-28 section-modern">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="font-headline text-4xl font-bold tracking-tight sm:text-5xl mb-3 text-[#285F65]">
                ...
                <CarouselItem key={idx} className="md:basis-1/2 lg:basis-1/3">
                  <div className="p-2 group">
                    <div className="relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300 bg-white w-full flex items-center justify-center">
                      <Image
                        src={`/testimonios-inicio/testimonio-${idx + 1}.${
                          idx < 3 ? "webp" : "png"
                        }`}
          ...
          <div
            ref={videoSectionRef}
            className="mt-10 flex flex-col lg:flex-row justify-center gap-8 lg:gap-12 max-w-6xl mx-auto"
          >
            {videosVisible ? (
              <>
              ...
              <div className="w-full lg:flex-1">
                <div className="video-wrapper-horizontal">
                  <div className="h-[220px] md:h-[260px] lg:h-[300px] w-full animate-pulse bg-muted rounded-xl" />
                </div>
              </div>
            )}
          </div>
