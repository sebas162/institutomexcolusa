                    ...
                    <div key={idx} className="border-l-2 border-primary/30 pl-4">
                      ...
                      <ul className="space-y-1">
                        {module.topics.map((topic: string, topicIdx: number) => {
                          ...
                          const showBullet = topicIdx !== 0 && !topic.startsWith('**') && !topic.includes('Master modeling techniques in:') && !topic.includes('Master modeling techniques for:') && !topic.includes('Domina técnicas de modelado en:') && !topic.includes('Learn to relax facial muscles to prevent and treat expression lines in:') && !topic.includes('Aprende a relajar los músculos faciales para prevenir y tratar líneas de expresión en:') && !topic.includes('Apply rejuvenation protocols with immediate lifting effect in:') && !topic.includes('Apply rejuvenation protocols with immediate lifting effect for:') && !topic.includes('Apply rejuvenation protocols with **immediate lifting effect** for:') && !topic.includes('Apply rejuvenation protocols with immediate lifting effects in:') && !topic.includes('Aplica protocolos de rejuvenecimiento con efecto lifting inmediato en:') && !topic.includes('Know the main biostimulators available in the market and their application in:') && !topic.includes('Conoce los principales bioestimuladores disponibles en el mercado y su aplicación en:') && !topic.includes('Learn about the main bio-stimulators available in the market and their application in:') && !topic.includes('Learn about leading biostimulators available in the market and their applications in:') && !topic.includes('Discover the main biostimulators available on the market and their application for:') && !topic.includes('Demonstrative Practice') && !topic.includes('Práctica Demostrativa') && !topic.includes('Delivery of Certificates') && !topic.includes('Entrega de Certificados') && !topic.includes('Photographic record') && !topic.includes('Registro fotográfico') && !topic.includes('Final Exam') && !topic.includes('Examen Final') && !topic.includes('Upon passing') && !topic.includes('Al aprobar') && !isLongText && !isLongParagraph && !startsWithNewline && !startsWithNumber;
                          return (
