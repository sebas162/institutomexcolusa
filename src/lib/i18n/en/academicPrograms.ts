            ...
            courseDetails: {
              ...
              'intravenous-therapy-chelation': {
                ...
                targetAudience: {
                  ...
                  description: '**Regenerative Medicine and Serum Therapy** have proven to be areas of great impact on patient health and well-being. However, worldwide, complications have arisen due to the improper practice of these treatments, often performed by personnel without adequate training.\n\nFor this reason, our program is designed for **healthcare professionals**, providing them with the tools and knowledge necessary to apply these therapies safely and effectively.\n\nAt **INSTITUTO MEX-COL-USA**, we responsibly take on the challenge of preventing these situations from occurring, promoting proper training for all specialists involved in these practices. \n\n**We focus on preparing professionals who apply Regenerative Medicine and Serum Therapy with safety, ethics, and excellence, always safeguarding the health and well-being of their patients.**'
                },
                curriculum: [
                  {
