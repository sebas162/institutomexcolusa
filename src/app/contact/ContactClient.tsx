...
import ContactanosHero from "@/assets/img-heros/contactanos.webp";
    ...
    mexico: [
      {
        ...
        address:
          "Av. Insurgentes Sur 546-piso 7, Roma Sur, Cuauhtémoc, 06760, CDMX",
        phones: [
      ...
      },
      {
        city:
          language === "es"
            ...
            : "Orlando Florida - Administrative Offices",
      ...
      <div className="container mx-auto px-4 pb-10 pt-20">
        <section>
          <Tabs
            ...
            onValueChange={(v) =>
              setSelectedCountry(v as "colombia" | "mexico" | "usa")
            }
            className="w-full"
          >
            ...
            <div className="flex flex-col gap-4">
              {offices[selectedCountry].map((o) => (
                <Card key={`${selectedCountry}-${o.city}`} className="w-full">
                  <CardHeader>
                    <CardTitle className="font-headline text-foreground font-semibold">
                      {o.city}
                    </CardTitle>
                  </CardHeader>
        ...
        <section className="sr-only" aria-label="Contact and locations">
          <h2>Contacto y Ubicaciones</h2>
          <p>
            Ponte en contacto con Instituto Mex-Col-USA para consultas sobre
            cursos, formación y capacitación en medicina estética. Ubicaciones
            en USA, México y Colombia con atención personalizada y asesoría
            profesional.
          </p>
          <p>
            Disponibles para consultas sobre programas académicos, cursos
            online, congresos y capacitación especializada en medicina y
            procedimientos estéticos internacionales.
          </p>
          <ul>
            <li>Ubicación USA</li>
            <li>Ubicación México</li>
            <li>Ubicación Colombia</li>
            <li>Consultas Online Disponibles</li>
          </ul>
        </section>
      </div>
    </div>
