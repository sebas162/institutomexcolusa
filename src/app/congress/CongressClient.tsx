...
import HeroConferencias from "@/assets/img-heros/hero-conferencias.webp";
...
export default function CongressClient() {
    ...
    if (!eventSchema) {
      ...
      script.textContent = JSON.stringify({
        ...
        name: isEN
          ...
          : "Congreso Internacional de Medicina Estética",
        description: isEN
          ? "International conference on aesthetic medicine with expert speakers from USA, Mexico, and Colombia. Practical demonstrations and professional certification."
          : "Congreso internacional de medicina estética con ponentes expertos de USA, México y Colombia. Demostraciones prácticas y certificación profesional.",
        organizer: {
          "@type": "Organization",
        ...
        offers: {
          "@type": "Offer",
          url: "https://www.institutomexcolusa.com/congress/",
          priceCurrency: "USD",
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {t.raffleItems.map((item, index) => (
              <Card
                key={index}
                className="modern-card text-center hover:shadow-lg transition-all duration-300"
              >
                <CardContent className="p-6">
      ...
      <section
        className="sr-only"
        aria-label="International aesthetic medicine congress"
      >
        <h2>Congreso Internacional de Medicina Estética</h2>
        <p>
          Instituto Mex-Col-USA organiza un congreso internacional de medicina
          estética con expertos en lifting, suero terapia, armonización facial y
          procedimientos no invasivos. Conferencias, demostraciones prácticas y
          capacitación certificada con profesionales de USA, México y Colombia.
        </p>
        <p>
          Evento internacional con oportunidades de networking profesional,
          actualización en técnicas modernas y acceso a ponentes expertos en
          medicina y estética mundial.
        </p>
        <ul>
          <li>Conferencias de Medicina Estética</li>
          <li>Demostraciones de Lifting Facial</li>
          <li>Capacitación en Procedimientos Avanzados</li>
