  ...
  const speakers: Record<Lang, Person[]> = {
    es: [
      ...
      },
      {
        ...
        photo: BravoImage,
        bio: "Médico Cirujano con experiencia en Medicina Interna y Medicina Crítica, con Maestría en Ciencias en Inmunogenética y Biología Molecular.\n\nProfesor Invitado MEX-COL-USA desde 2023, investigador clínico con 12 publicaciones nacionales y 9 internacionales, y ganador de 3 premios a la investigación clínica.\n\nPonente internacional, asesor y docente, ha dictado más de 530 cursos de capacitación y alrededor de 726 pláticas científicas en Congresos Internacionales, Nacionales y en foros dentro de la comunidad médica. Cuenta con 33 años de experiencia en la Industria Farmacéutica (Ex-Director médico de 13 laboratorios farmacéuticos), certificación en Medicina Regenerativa y uso de Células Madre por el International Society for Stem Cell Application (ISSCA), así como (Certificación en Medicina Estética por la Alianza Americana desde 2022).\n\nEl Dr. Martín Bravo ha interactuado con más de 2500 médicos y profesionales de la salud y con más de 1,900 pacientes en los últimos 4 años en sus diferentes intervenciones en cursos, consultas y en foros médicos.",
      },
      {
    ...
    en: [
      ...
      },
      {
        ...
        photo: BravoImage,
        bio: "Physician and Surgeon with experience in Internal Medicine and Critical Care Medicine, holding a Master's Degree in Immunogenetics and Molecular Biology.\n\nGuest Professor at MEX-COL-USA since 2023, clinical researcher with 12 national and 9 international publications, and winner of 3 clinical research awards.\n\nInternational speaker, advisor, and lecturer, having delivered more than 530 training courses and around 726 scientific talks at International and National Congresses and forums within the medical community. He brings 33 years of experience in the Pharmaceutical Industry (Former Medical Director of 13 pharmaceutical laboratories), certification in Regenerative Medicine and Stem Cell use from the International Society for Stem Cell Application (ISSCA), as well as (Certification in Aesthetic Medicine from the Alianza Americana since 2022).\n\nDr. Martín Bravo has interacted with more than 2,500 physicians and healthcare professionals and with more than 1,900 patients over the last 4 years across his various course, consultation, and medical forum engagements.",
      },
      {
        name: "Dr. Alejandro Bravo",
