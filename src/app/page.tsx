        ...
        <div className="relative z-10 h-full container mx-auto px-4 flex flex-col">
          ...
          <div className="mt-60 flex flex-col items-center text-center md:items-start md:text-left text-white gap-3 pb-6 md:pb-12 lg:pb-16 md:ml-5">
            <h1 className="font-headline text-4xl md:text-6xl font-bold tracking-tight drop-shadow-lg">
              {(() => {
                const title = th.hero.main;
                const splitIndex = title.indexOf('Mex');
                if (splitIndex > 0) {
            ...
            <p className="text-base md:text-2xl text-white/90 leading-relaxed drop-shadow-md max-w-xl md:max-w-2xl">
              {th.hero.sub}
            </p>
      ...
      <section id="testimonials" className="py-20 md:py-28 section-modern section-testimonials">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl p-6 md:px-16 shadow-lg">
            ...
            {/* Video Section */}
            <div className="mt-8 md:flex justify-center gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            ...
            <Card className="hover:shadow-lg transition-all duration-300" style={{ backgroundColor: '#FFFFFF' }}>
              <CardHeader>
                <div className="text-center">
                  <MapPin className="h-8 w-8 mx-auto mb-2" style={{ color: '#285F65' }} />
                  <CardTitle className="font-semibold mb-2" style={{ color: '#1F2937' }}>{th.contact.locations.mx.title}</CardTitle>
