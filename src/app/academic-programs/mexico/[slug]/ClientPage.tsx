                  ...
                  <div className="flex justify-center">
                    <VideoCard
                      ...
                      src={`https://www.youtube.com/embed/${
                        (courseDetails as any).testimonial.videoId
                      }`}
                    />
                  </div>

                  {/* Local testimonial videos - grid */}
                  {slug === "facial-harmonization-course" && (
                    <div className="mt-8">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                          "/video-testimonios/testimonios-armonizacion-mx/armonizacion%20facial%20mx%202.MP4",
                          "/video-testimonios/testimonios-armonizacion-mx/armonizacion%20facial%20mx%203.MP4",
                          "/video-testimonios/testimonios-armonizacion-mx/armonizacion%20facial%20mx5.MP4",
                          "/video-testimonios/testimonios-armonizacion-mx/armonizacion%20facial%20mx%206.MP4",
                        ].map((videoSrc, idx) => (
