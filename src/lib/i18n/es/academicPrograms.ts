export const academicPrograms = {
  ...
  subtitle:
    "Formación internacional con programas especializados, prácticos y actualizados en USA, México y Colombia.",
  ...
  countries: {
    usa: {
      courses: [
        {
          title:
            'Master class 4 técnicas armonización, modelación y perfilación facial "toxina botulínica / ácido hialurónico / bioestimuladores / hilos pdo"',
          description:
            "Aprende técnicas avanzadas para armonización facial con resultados profesionales.",
      ...
      courseDetails: {
        "master-class-4-techniques": {
          ...
          curriculum: [
            ...
            {
              title: "Día 2 – Práctica demostrativa",
              topics: [
          ...
          includes: [
            ...
            "Videos de aplicación de **hilos PDO**",
        ...
        "phlebotomy-course": {
          ...
          targetAudience: {
            ...
            description:
              "El curso de **flebotomía** en Estados Unidos está dirigido a todos los **profesionales del área de la salud** que deseen ampliar sus conocimientos y habilidades en la extracción y manejo de muestras sanguíneas. Pueden participar **enfermeros, médicos, técnicos de laboratorio, asistentes médicos, paramédicos, estudiantes de ciencias de la salud** y otros profesionales vinculados a la atención del paciente.\n\nEste programa es ideal para quienes buscan **fortalecer su perfil profesional**, cumplir con requisitos laborales en clínicas, hospitales o laboratorios, o iniciar una carrera técnica dentro del sistema de salud estadounidense. No se requiere experiencia previa en flebotomía, pero se valora contar con formación o práctica en áreas clínicas.",
          },
          curriculum: [
            {
              title: "Contenido del curso",
    ...
    mexico: {
      courses: [
        {
          title:
            'Curso de modelación, perfilación y armonización facial con "toxina botulínica / ácido hialurónico / bioestimuladores / hilos PDO"',
          description:
            "Aprende técnicas avanzadas para armonización facial con resultados naturales y precisos.",
      ...
      courseDetails: {
        ...
        "intravenous-therapy-mexico": {
          ...
          includes: ["Incluye material de apoyo digital"],
          accreditations: [
      ...
      courses: [
        {
          title:
            "Master class 4 técnicas armonización, modelación y perfilación facial “toxina botulínica / ácido hialurónico / bioestimuladores / hilos PDO”.",
          description:
            "Aprende técnicas avanzadas de armonización facial para resultados profesionales y naturales.",
