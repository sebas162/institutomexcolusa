...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    alternates: {
      canonical: `${baseUrl}/academic-programs/mexico/${slug}`,
    },
  };
}
...
export default async function Page({
  ...
  const { slug } = await params;
  const courseDetails = (
    translations.es.academicPrograms.countries.mexico.courseDetails as any
  )?.[slug];
        ...
        breadcrumb: {
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 3,
              name: "México",
              item: `${baseUrl}/academic-programs/mexico/`,
            },
            {
              "@type": "ListItem",
              position: 4,
              name: courseDetails.title,
              item: `${baseUrl}/academic-programs/mexico/${slug}/`,
            },
          ],
        },
